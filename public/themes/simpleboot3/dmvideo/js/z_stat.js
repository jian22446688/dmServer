(function() {
    ...
    k.prototype = {
            ...
            try {
                ...
                case "_setCustomVar":
                    if (3 <= a.length) {
                        ...
                        if (5 <= a) return ! 1;
                        var m = 0 == l ? "p": -1 == l || -2 == l ? l: (new Date).getTime() + 1E3 * l;
                        this.a.b[d] = {};
                        this.a.b[d].da = n;
                        this.a.b[d].h = m;
                        this.I()
                ...
                case "_setUUid":
                    var k = a[1];
                    if (128 < k.length) return ! 1;
                    var p = new Date;
                    p.setTime(p.getTime() + 157248E5);
                    this.aa(this.P, k, p)
                }
            } catch(x) {
                g(x, "aC failed")
        ...
        sa: function() {
            try {
                if ("" !== e.location.hash) return this.N = e.location.href
            } catch(a) {
                g(a, "gCP failed")
            }
        },
        ...
        ya: function() {
            try {
                ...
                if (!h.domain) return this.a.Ja = "none";
        ...
        Ia: function() {
            try {
                ...
                this.Y && b.push("show=" + f(this.Y));
                this.X && b.push("online=" + f(this.X));
                this.V && b.push("l=" + f(this.V));
        ...
        Z: function() {
            try {
                ...
                } else "none" !== this.a.l ? b.push("cnzz_eid=" + f(this.a.l)) : (d = Math.floor(2147483648 * Math.random()) + "-" + this.D + "-" + this.M(this.o()), b.push("cnzz_eid=" + f(d))),
                b.push("ntime=" + this.D),
                0 < b.length ? (a += f(b.join("&")), a += "; expires=" + c.toUTCString(), a += "; path=/") : a += "; expires=" + (new Date(0)).toUTCString();
                h.cookie = a
            } catch(n) {
        ...
        na: function(a, b) {
            try {
                ...
                } else h.write(r("%3Cscript src='./js/core.js' charset='" + b + "' type='text/javascript'%3E%3C/script%3E"))
            } catch(n) {
                g(n, "cAS failed")
            }
        },
        pa: function(a, b) {
            try {
                ...
                if (c) {
                    ...
                    d.src = a;
                    c.appendChild(d)
                } else "0" === this.A && h.write(r("%3Cscript src='" + a + "' charset='" + b + "' type='text/javascript'%3E%3C/script%3E"))
            } catch(n) {
                g(n, "cSI failed")
            }
        },
        oa: function(a) {
            try {
                ...
                e ? e.innerHTML = c: "0" === this.A && h.write(c)
            } catch(l) {
                g(l, "cI failed")
            }
        },
        s: function() {
            try {
                ...
                b = [];
                b.push("id=" + f(this.c));
                this.a.g || "" === this.a.g ? b.push("r=" + f(this.a.g)) : b.push("r=" + f(this.a.Ha));
                b.push("lg=" + f(this.a.B));
                b.push("ntime=" + f(this.a.Da));
                b.push("cnzz_eid=" + f(this.a.l));
                b.push("showp=" + f(this.a.ba));
                this.a.f ? b.push("p=" + f(this.a.f)) : "[object String]" === {}.toString.call(this.N) && b.push("p=" + f(this.N));
                "[object String]" === {}.toString.call(this.v) && b.push("ei=" + f(this.v));
                "[object String]" === {}.toString.call(this.b) && b.push("cv=" + this.b);
                "[object String]" === {}.toString.call(this.F) && b.push("pc=" + f(this.F));
                "[object String]" === {}.toString.call(this.u) && b.push("ai=" + this.u);
                a && b.push("uuid=" + f(a));
                b.push("t=" + f(this.a.Fa));
                b.push("umuuid=" + f(this.a.R));
                b.push("h=1");
                var c = b.join("&");
                "[object String]" === {}.toString.call(this.v) ? this.j([q + "//ei.cnzz.com/stat.htm?" + c]) : this.F || this.u ? this.j([u + "/stat.htm?" + c]) : (this.W && this.j([q + "//" + this.W + "/stat.htm?" + c]), this.$ && this.j([q + "//" + this.$ + "/stat.htm?" + c]))
            } catch(d) {
                g(d, "sD failed")
            }
        },
    ...
    try {
        var p = new k;
        e[p.G].bobject = p; ! 1 !== e._cz_autoPageview ? p.s() : p.Z();
        k.prototype.getACookie = k.prototype.m;
        k.prototype.callRequest = k.prototype.j;
        k.prototype.createScriptIcon = k.prototype.pa;
        k.prototype.createIcon = k.prototype.oa;
        p.Ia();
        p.ga()
    } catch(a) {
        g(a, "main failed")
