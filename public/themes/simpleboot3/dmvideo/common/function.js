...
define(function (require, exports, module) {
    module.exports = {
        ...
        startmarquee: function (lh, speed, delay, index) {
            var t;
            var p = false;
        ...
        GetDomainName: function () {//获取域名后缀
            var url = window.location.host;
            url = url.substring(url.lastIndexOf('.'));
            return url;
        },
        message_im: function (obj) {//即时通讯 IM
            $(obj).click(function () {
        ...
        GetRefErrer: function () {//跨域设置access_origin（cookie）
